...
def get_parser():
    ...
    parser.add_argument("--file", help="File to be read, catid per line (10400100175E5C00,104A0100159AFE00,"
                                          "104001002A779400,1040010026627600)")
    parser.add_argument("--shape", help="Name of shapefile to be read", type=open_shape)
